...
if __name__ == "__main__":
    ...
    build()
    print("Done. Header/footer/data are now inlined for every page with a BUILD:DATA marker —")
    print("no runtime fetch required, works over file:// with no server. Every core page")
    print("(index, all 13 department pages, recommendations, funding, timeline) has one.")
    print("Add a BUILD:DATA marker to any new page that starts loading data/*.json, same")
    print("pattern as departments/water-resources.html.")
